...
#include <adatcpclient.h>
#include <adatcpclienterrorex.h>

#define RECORD_BUFFER_SIZE (256)

CE_INT4 adatcpclientconnect_connect(CE_NCHAR             *connect_string,
                                    CE_CHAR              *nodeid,
                                    CE_CHAR              *userid,
                                    CE_UINT4              pid,
                                    CE_UINT8              timestamp,
...
int main(int argc, const char **argv) {
    ...
    adatcpclientconnect_connect("adatcp://localhost:55181", "susada2c", "adrd", get_pid(), get_timestamp(), **handle);
